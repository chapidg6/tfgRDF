...
.formulario-csv input,
.formulario-csv button {
    display: block;
    margin-left: 36%;
}
...
<form id="formularioJson" action="Json" method="post" enctype="multipart/form-data">
    <input type="file" id="fileInputJson"  name="fileInputJson" class="fileInputJson">
    <button id="subirArchivoJson" class="boton-formulario-json" type="submit" disabled>Subir Archivo</button>
</form>
   ...
   <div id="formulario-csv" class="formulario-csv">
    ...
    <h3> Selecciona el archivo CSV a transformar</h3>
      ...
      <!--  enctype="multipart/form-data" para poder enviar archivos -->    
     <form id="formularioCSV" action="Csv" method="post" enctype="multipart/form-data">			
 	<input type="file" id="fileInputCsv"  name="fileInputCsv" class="fileInputCsv">
    <button id="subirArchivoCsv" class="boton-formulario-csv" type="submit" disabled>Subir Archivo</button>			
...
// Obtener referencia a los elementos Json
const fileInputJson = document.getElementById('fileInputJson');
const subirArchivoJson = document.getElementById('subirArchivoJson');

// Agregar un event listener para detectar cambios en el campo de entrada de archivo
...
//Obtener referencia a los elementos Csv
