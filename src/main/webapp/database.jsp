...
<body>
	...
	<div class="container">
		...
		<h2 class="title-table">TABLA PERSONAS</h2>
		...
		<table class="tabla" border="1">
			...
			<tbody>
				<%
				// Iterar sobre la lista de personas y crear una fila por cada persona
				for (Persona persona : (List<Persona>) request.getAttribute("personas")) {
				%>
				<tr>
					<td><%=persona.getId()%></td>
		...
		<form id="rdfForm" action="DataBase" method="post"
			...
			<div id="formPopUp" class="popup">
				<div class="popup-contenido">
					...
					<br> <br> <label for="serializacion">Formato de
    ...
    function validarFormulario() {
        ...
        if (nombreArchivo.trim() === "") {
            alert("Por favor, rellene el campo nombre del archivo.");
          	return false
        }
